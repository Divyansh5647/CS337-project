...
def get_datasets(name, root, cutout, no_aug=False):
  ...
  if name == 'cifar10' or name == 'cifar100':
    ...
    xlists.append( normalize )
    train_transform = transforms.Compose(xlists)
    #test_transform  = transforms.Compose(xlists)
  ...
  if name == 'cifar10':
    ...
    test_data  = TinyImageNetDataset(osp.join(root, 'test'),   test_transform)
    #val_data = TinyImageNetDataset(osp.join(root, 'val'),   val_transform)
    ...
    #return train_data, test_data,val_data, xshape, class_num
